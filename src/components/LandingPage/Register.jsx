...
function Register() {
    ...
    return (
        ...
        <div class="container mt-3">
            <form>
                <div class="row jumbotron box8" style={boxStyle}>
                    <div class="col-sm-12 mx-t3 mb-4" style={mxt3}>
                        <h1 class="text-center text-info">Register</h1>
                    </div>
                    <div class="col-sm-6 form-group px-4">
                        <label for="name-f">First Name</label>
                        <input type="text" class="form-control" name="fname" id="name-f" placeholder="Enter your first name." required />
                    </div>
                    <div class="col-sm-5 form-group px-4">
                    ...
                    <div class="col-sm-5 form-group px-4">
                        <label for="State">Sub City</label>
                        <input type="address" class="form-control" name="State" id="State" placeholder="Enter name of your subcity." required />
                    </div>
                    <div class="col-sm-6 form-group px-4">
                    ...
                    <div class="col-sm-6 form-group px-4 pr-6">
                    ...
                    <div class="col-sm-2 form-group px-4">
                        <label for="cod">Country code</label>
                        <select class="form-control browser-default custom-select">
                            <option data-countryCode="ET" value="1" selected>Ethiopia (+251)</option>
                    ...
                    <div class="col-sm-4 form-group px-4">
                    ...
                    <div class="col-sm-12 form-group px-4 mb-0">
